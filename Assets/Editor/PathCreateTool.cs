...
public class PathCreateTool : EditorWindow
{
    ...
    private void OnSelectionChanged()
    {
        ...
        if (selectedObject != null && selectedObject.TryGetComponent<WaypointPath>(out var waypointPath))
        {
            ExitBuildingMode();
    ...
    private void CreatePath()
    {
        ...
        currSelectedPath = path.AddComponent<WaypointPath>();
